...
public class Server extends JFrame implements ActionListener {
    ...
    Server() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/professional2-min.jpg"));
        Image i5 = i4.getImage().getScaledInstance(50, 70, Image.SCALE_SMOOTH);
        ...
        new Thread(() -> {
            try {
                ...
                JLabel infoLabel = new JLabel(
                        "<html><div style='color:gray;font-size:12px;text-align:center;'>Server started on port 6001.<br>Waiting for client connection...</div></html>");
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    JLabel connectedLabel = new JLabel(
                            "<html><div style='color:green;font-size:12px;text-align:center;'>Client connected successfully!</div></html>");
                ...
                SwingUtilities.invokeLater(() -> {
                    ...
                    JLabel errorLabel = new JLabel(
                            "<html><div style='color:red;font-size:12px;'>Connection lost. Restart the application.</div></html>");
    ...
    private void scrollToBottom() {
        p2.validate();
        p2.repaint();
        // Use SwingUtilities.invokeLater to ensure scrolling happens after layout is
        // complete
        SwingUtilities.invokeLater(() -> {
            ...
            if (!out.equals("")) {
                if (!connected) {
                    ...
                    JLabel warningLabel = new JLabel(
                            "<html><div style='color:red;font-size:12px;'>Cannot send message: No client connected</div></html>");
